	...
	<form id="mainForm" action="${ctx}/snaker/task/active" method="get">
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td class="td_table_top" align="left">
					待办任务<font color="red">[共:${majorTotal }项]&nbsp;&nbsp;<a href="${ctx}/snaker/task!activeTaskList.action?taskType=0&processId=${processId}">更多...</a></font>
				</td>
			</tr>
		</table>
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
 		...
 		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td class="td_table_top" align="left">
					协办任务<font color="red">[共:${aidantTotal }项]&nbsp;&nbsp;更多...</font>
				</td>
			</tr>
		</table>
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<c:forEach items="${aidantWorks}" var="item">
				<tr>
					...
					<td class="td_list_2" align=left nowrap>
						<a href="${ctx}/process/display?processId=${item.processId }&orderId=${item.orderId} " class="btnPict" title="查看流程图">查看流程图</a>
						<a href="${ctx}${empty item.instanceUrl ? item.actionUrl : item.instanceUrl }?processId=${item.processId }&taskId=${item.taskId}&orderId=${item.orderId} " class="btnEdit" title="处理">处理</a>
					</td>
					<td class="td_list_2" align=left nowrap>&nbsp;</td>
				</tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td class="td_table_top" align="left">
					抄送任务<font color="red">[共:${ccorderTotal }项]&nbsp;&nbsp;更多...</font>
				</td>
			</tr>
		</table>
