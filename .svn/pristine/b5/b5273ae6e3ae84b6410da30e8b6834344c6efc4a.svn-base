...
public class AcceptanceManageDao extends DbOperator{
	
	private static AcceptanceManageDao instance = null;
	public static AcceptanceManageDao getInstance()
	{
		if(instance==null)
		{
			synchronized (ClientDao.class)
			{
			  instance = new AcceptanceManageDao();
			}
		}
		return instance;
	}
	...
	public  Map<String, String> getList_Column()
	{
		...
		sb.append(" FROM jsgl_acceptancemanage");
	...
	public List<Map<String, Object>> getExportDara(Map<String, Object> map) throws UnsupportedEncodingException 
	 {
			...
			String sql = "select a.* from jsgl_acceptancemanage a  "
	 ...
	 * @return
	 */
	public OraPaginatedList queryAcceptanceManage(Map<String, Object> map,int pageNum,int pageSize) 
	{
		String condition=this.getDesSql(map);
		String conditionP = "";
		String param = "";
	 ...
	 * @return
	 */
	public boolean addAcceptanceManage(Map<String, Object> map)
	{
		StringBuilder sb=new StringBuilder();
		sb.append("insert into jsgl_acceptancemanage(filename,publisher,type,createtime,filepath) values(?,?,?,?,?)");
	 ...
	 * @return
	 */
	public boolean updateAcceptanceManage(Map<String, Object> map)
	{

		StringBuilder sb=new StringBuilder();
		sb.append("update jsgl_acceptancemanage set filename=?,publisher=?,type=?,createtime=?,filepath=?where id =? ");
	 ...
	 * @return
	 */
	public boolean deleteAcceptanceManage(String id)
	{	
		StringBuilder sb=new StringBuilder();
		sb.append("delete from jsgl_acceptancemanage where id =? ");
