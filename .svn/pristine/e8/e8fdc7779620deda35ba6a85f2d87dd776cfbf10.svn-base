...
public class QualityReportDao extends DbOperator{
	
	private static QualityReportDao instance = null;
	public static QualityReportDao getInstance()
	{
		if(instance==null)
		{
			synchronized (ClientDao.class)
			{
			  instance = new QualityReportDao();
			}
		}
		return instance;
	}
	...
	public List<Map<String, Object>> getExportDara(Map<String, Object> map) throws UnsupportedEncodingException 
	 {
			...
			String sql = "select a.* from jsgl_qualityreport a  "
	 ...
	 * @return
	 */
	public OraPaginatedList queryQualityReport(Map<String, Object> map,int pageNum,int pageSize) 
	{
		String condition=this.getDesSql(map);
		String conditionP = "";
		String param = "";
	 ...
	 * @return
	 */
	public boolean addQualityReport(Map<String, Object> map)
	{
		StringBuilder sb=new StringBuilder();
		sb.append("insert into jsgl_qualityreport(filename,publisher,type,createtime,filepath) values(?,?,?,?,?)");
	 ...
	 * @return
	 */
	public boolean updateQualityReport(Map<String, Object> map)
	{

		StringBuilder sb=new StringBuilder();
		sb.append("update jsgl_qualityreport set filename=?,publisher=?,type=?,createtime=?,filepath=?where id =? ");
	 ...
	 * @return
	 */
	public boolean deleteQualityReport(String id)
	{	
		StringBuilder sb=new StringBuilder();
		sb.append("delete from jsgl_qualityreport where id =? ");
