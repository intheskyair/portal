...
public class FileManageDao extends DbOperator{
	
	private static FileManageDao instance = null;
	...
	public  Map<String, String> getList_Column()
	{
		...
		sb.append(" FROM jsgl_filemanage");
	...
	public List<Map<String, Object>> getExportDara(Map<String, Object> map) throws UnsupportedEncodingException 
	 {
			...
			String sql = "select a.* from jsgl_filemanage a  "
	 ...
	 * @return
	 */
	public OraPaginatedList queryFileManage(Map<String, Object> map,int pageNum,int pageSize) 
	{
		String condition=this.getDesSql(map);
		String conditionP = "";
		String param = "";
	 ...
	 * @return
	 */
	public boolean addFileManage(Map<String, Object> map)
	{
		StringBuilder sb=new StringBuilder();
		sb.append("insert into jsgl_filemanage(filename,publisher,type,createtime,filepath) values(?,?,?,?,?)");
	 ...
	 * @return
	 */
	public boolean updateFileManage(Map<String, Object> map)
	{

		StringBuilder sb=new StringBuilder();
		sb.append("update jsgl_filemanage set filename=?,publisher=?,type=?,createtime=?,filepath=?where id =? ");
	 ...
	 * @return
	 */
	public boolean deleteFileManage(String id)
	{	
		StringBuilder sb=new StringBuilder();
		sb.append("delete from jsgl_filemanage where id =? ");
