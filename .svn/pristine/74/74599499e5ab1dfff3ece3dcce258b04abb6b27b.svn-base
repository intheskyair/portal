...
public class ProjectSettlementDao extends DbOperator{
	
	private static ProjectSettlementDao instance = null;
	public static ProjectSettlementDao getInstance()
	{
		if(instance==null)
		{
			synchronized (ClientDao.class)
			{
			  instance = new ProjectSettlementDao();
			}
		}
		return instance;
	}
	...
	public  Map<String, String> getList_Column()
	{
		...
		sb.append(" FROM jsgl_projectsettlement");
	...
	public List<Map<String, Object>> getExportDara(Map<String, Object> map) throws UnsupportedEncodingException 
	 {
			...
			String sql = "select a.* from jsgl_projectsettlement a  "
	 ...
	 * @return
	 */
	public OraPaginatedList queryProjectSettlement(Map<String, Object> map,int pageNum,int pageSize) 
	{
		String condition=this.getDesSql(map);
		String conditionP = "";
		String param = "";
	 ...
	 * @return
	 */
	public boolean addProjectSettlement(Map<String, Object> map)
	{
		StringBuilder sb=new StringBuilder();
		sb.append("insert into jsgl_projectsettlement(filename,publisher,type,createtime,filepath) values(?,?,?,?,?)");
	 ...
	 * @return
	 */
	public boolean updateProjectSettlement(Map<String, Object> map)
	{

		StringBuilder sb=new StringBuilder();
		sb.append("update jsgl_projectsettlement set filename=?,publisher=?,type=?,createtime=?,filepath=?where id =? ");
	 ...
	 * @return
	 */
	public boolean deleteProjectSettlement(String id)
	{	
		StringBuilder sb=new StringBuilder();
		sb.append("delete from jsgl_projectsettlement where id =? ");
