...
public class InvestPlanDao extends DbOperator{
	
	private static InvestPlanDao instance = null;
	public static InvestPlanDao getInstance()
	{
		if(instance==null)
		{
			synchronized (ClientDao.class)
			{
			  instance = new InvestPlanDao();
			}
		}
		return instance;
	}
	...
	public  Map<String, String> getList_Column()
	{
		...
		sb.append(" FROM tzgl_investplan");
	...
	public List<Map<String, Object>> getExportDara(Map<String, Object> map) throws UnsupportedEncodingException 
	 {
			...
			String sql = "select a.* from tzgl_investplan a  "
	 ...
	 * @return
	 */
	public OraPaginatedList queryInvestPlan(Map<String, Object> map,int pageNum,int pageSize) 
	{
		String condition=this.getDesSql(map);
		String conditionP = "";
		String param = "";
	 ...
	 * 
	 */
	public boolean addInvestPlan(Map<String, Object> map)
	{
		StringBuilder sb=new StringBuilder();
		sb.append("insert into tzgl_investplan(projectname,bulidscale,totalinvest,firstquarter,secondquarter,thirdquarter,fourthquarter) values(?,?,?,?,?,?,?)");
	 ...
	 */
	public boolean updateInvestPlan(Map<String, Object> map)
	{

		StringBuilder sb=new StringBuilder();
		sb.append("update tzgl_investplan set projectname=?,bulidscale=?,totalinvest=?,firstquarter=?,secondquarter=?,thirdquarter=?,fourthquarter=? where id =? ");
	 ...
	 * @return
	 */
	public boolean deleteInvestPlan(String id)
	{	
		StringBuilder sb=new StringBuilder();
		sb.append("delete from tzgl_investplan where id =? ");
