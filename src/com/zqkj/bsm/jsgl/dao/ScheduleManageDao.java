...
public class ScheduleManageDao extends DbOperator{
	
	private static ScheduleManageDao instance = null;
	public static ScheduleManageDao getInstance()
	{
		if(instance==null)
		{
			synchronized (ClientDao.class)
			{
			  instance = new ScheduleManageDao();
			}
		}
		return instance;
	}
	...
	public  Map<String, String> getList_Column()
	{
		...
		sb.append(" FROM jsgl_schedulemanage");
	...
	public List<Map<String, Object>> getExportDara(Map<String, Object> map) throws UnsupportedEncodingException 
	 {
			...
			String sql = "select a.* from jsgl_schedulemanage a  "
	 ...
	 * @return
	 */
	public OraPaginatedList queryScheduleManage(Map<String, Object> map,int pageNum,int pageSize) 
	{
		String condition=this.getDesSql(map);
		String conditionP = "";
		String param = "";
	 ...
	 * @return
	 */
	public boolean addScheduleManage(Map<String, Object> map)
	{
		StringBuilder sb=new StringBuilder();
		sb.append("insert into jsgl_schedulemanage(filename,publisher,type,createtime,filepath) values(?,?,?,?,?)");
	 ...
	 * @return
	 */
	public boolean updateScheduleManage(Map<String, Object> map)
	{

		StringBuilder sb=new StringBuilder();
		sb.append("update jsgl_schedulemanage set filename=?,publisher=?,type=?,createtime=?,filepath=?where id =? ");
	 ...
	 * @return
	 */
	public boolean deleteScheduleManage(String id)
	{	
		StringBuilder sb=new StringBuilder();
		sb.append("delete from jsgl_schedulemanage where id =? ");
