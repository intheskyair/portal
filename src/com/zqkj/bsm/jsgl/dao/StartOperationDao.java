...
public class StartOperationDao extends DbOperator{
	
	private static StartOperationDao instance = null;
	public static StartOperationDao getInstance()
	{
		if(instance==null)
		{
			synchronized (ClientDao.class)
			{
			  instance = new StartOperationDao();
			}
		}
		return instance;
	}
	...
	public  Map<String, String> getList_Column()
	{
		...
		sb.append(" FROM jsgl_startoperation");
	...
	public List<Map<String, Object>> getExportDara(Map<String, Object> map) throws UnsupportedEncodingException 
	 {
			...
			String sql = "select a.* from jsgl_startoperation a  "
	 ...
	 * @return
	 */
	public OraPaginatedList queryStartOperation(Map<String, Object> map,int pageNum,int pageSize) 
	{
		String condition=this.getDesSql(map);
		String conditionP = "";
		String param = "";
	 ...
	 * @return
	 */
	public boolean addStartOperation(Map<String, Object> map)
	{
		StringBuilder sb=new StringBuilder();
		sb.append("insert into jsgl_startoperation(filename,publisher,type,createtime,filepath) values(?,?,?,?,?)");
	 ...
	 * @return
	 */
	public boolean updateStartOperation(Map<String, Object> map)
	{

		StringBuilder sb=new StringBuilder();
		sb.append("update jsgl_startoperation set filename=?,publisher=?,type=?,createtime=?,filepath=?where id =? ");
	 ...
	 * @return
	 */
	public boolean deleteStartOperation(String id)
	{	
		StringBuilder sb=new StringBuilder();
		sb.append("delete from jsgl_startoperation where id =? ");
