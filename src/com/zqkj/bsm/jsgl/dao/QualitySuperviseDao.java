...
public class QualitySuperviseDao extends DbOperator{
	
	private static QualitySuperviseDao instance = null;
	public static QualitySuperviseDao getInstance()
	{
		if(instance==null)
		{
			synchronized (ClientDao.class)
			{
			  instance = new QualitySuperviseDao();
			}
		}
		return instance;
	}
	...
	public  Map<String, String> getList_Column()
	{
		...
		sb.append(" FROM jsgl_qualitysupervise");
	...
	public List<Map<String, Object>> getExportDara(Map<String, Object> map) throws UnsupportedEncodingException 
	 {
			...
			String sql = "select a.* from jsgl_qualitysupervise a  "
	 ...
	 * @return
	 */
	public OraPaginatedList queryQualitySupervise(Map<String, Object> map,int pageNum,int pageSize) 
	{
		String condition=this.getDesSql(map);
		String conditionP = "";
		String param = "";
	 ...
	 * @return
	 */
	public boolean addQualitySupervise(Map<String, Object> map)
	{
		StringBuilder sb=new StringBuilder();
		sb.append("insert into jsgl_qualitysupervise(filename,publisher,type,createtime,filepath) values(?,?,?,?,?)");
	 ...
	 * @return
	 */
	public boolean updateQualitySupervise(Map<String, Object> map)
	{

		StringBuilder sb=new StringBuilder();
		sb.append("update jsgl_qualitysupervise set filename=?,publisher=?,type=?,createtime=?,filepath=?where id =? ");
	 ...
	 * @return
	 */
	public boolean deleteQualitySupervise(String id)
	{	
		StringBuilder sb=new StringBuilder();
		sb.append("delete from jsgl_qualitysupervise where id =? ");
